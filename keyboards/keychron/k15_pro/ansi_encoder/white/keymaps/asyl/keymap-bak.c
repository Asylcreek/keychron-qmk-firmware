...
const int P_MT_D = LALT_T(KC_D);
const int P_MT_F = LCTL_T(KC_F);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_90_ansi(
        ...
        MC_3,       KC_CAPS,  KC_A,     KC_S,     P_MT_D,   P_MT_F,   KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_HOME,
        MC_4,       KC_LSFT,            KC_Z,     KC_X,   KC_C,   KC_V,    KC_B,     KC_ESC,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
