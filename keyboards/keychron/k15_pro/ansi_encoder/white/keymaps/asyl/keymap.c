...
enum layers { MAC_BASE, MAC_FN, WIN_BASE, WIN_FN, SHORTCUTS, SHIFTED, SYM, CMD, SHORTS, TERM, NAV };
...
const uint16_t PROGMEM ENTSPC_TERM[] = {LT(SHIFTED, KC_ENT), LT(SYM, KC_SPC), COMBO_END};
const uint16_t PROGMEM SH_SHORTS[]   = {KC_S, KC_H, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_90_ansi(
        ...
        MC_3,       LT(NAV,KC_ESC),   KC_N,              KC_R,     KC_T,                  KC_S,     KC_G,      KC_Y,      KC_H,     KC_A,     KC_E,     KC_I,     KC_COMM,  KC_NO,   KC_HOME,
        KC_LGUI,    KC_LGUI,  KC_Q,              KC_X,     KC_M,                  KC_C,     KC_V,      MO(MAC_FN),KC_K,     KC_P,     KC_DOT,   KC_MINS,  KC_SLSH,  KC_TRNS,  KC_UP,
        MC_5,       HOMEROW,  HOMEROW_SCROLL,    LT(CMD,KC_NO),   LT(SHIFTED,KC_ENT),  KC_LSFT,  LT(SYM,KC_SPC),    KC_NO,    KC_NO,                                                 KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [SHIFTED] = LAYOUT_90_ansi(
        ...
        KC_TRNS,    KC_DEL,        S(KC_Q),  S(KC_X),  S(KC_M),   S(KC_C),     S(KC_V),KC_TRNS,S(KC_K),    S(KC_P),     S(KC_DOT),   S(KC_QUOT),  S(KC_COMM),  KC_TRNS,  KC_TRNS,
    ...
    [SYM] = LAYOUT_90_ansi(
        ...
        KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,
        KC_TRNS,    S(KC_5),  KC_EQL,  S(KC_9),  S(KC_COMM),  S(KC_LBRC),  KC_LBRC,   KC_RBRC,  S(KC_RBRC),  S(KC_DOT),  S(KC_0),  S(KC_EQL),  S(KC_BSLS),  KC_TRNS,  KC_TRNS,            KC_TRNS,
        KC_TRNS,    S(KC_4),  KC_1,    KC_2,  KC_3,  KC_4,  KC_5,   KC_6,  KC_7,  KC_8,   KC_9,    KC_0,   KC_BSLS,              KC_TRNS,            KC_TRNS,
        KC_TRNS,    S(KC_3),  S(KC_8),  S(KC_1),  S(KC_2),  KC_GRAVE,   S(KC_GRAVE),  KC_TRNS,  S(KC_7),  S(KC_6),  KC_DOT,  KC_MINS,  KC_SLSH,  KC_LSFT,  KC_TRNS,
        KC_TRNS,    KC_TRNS,  KC_TRNS,            KC_LCTL,  KC_LGUI,  KC_TRNS,             KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS),

    [CMD] = LAYOUT_90_ansi(
        KC_TRNS,    KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,            KC_TRNS,
        KC_TRNS,    KC_TRNS,        KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,     KC_TRNS,      KC_TRNS,      KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,    KC_TRNS,   KC_TRNS,            KC_TRNS,
        KC_TRNS,    G(KC_TAB),  G(KC_B),  G(KC_L),    G(KC_D),  G(KC_W),  G(KC_Z),   HYPR(KC_H),  G(KC_F),  G(KC_O),  G(KC_U),  G(LOPT(KC_J)),  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,
        KC_TRNS,    C(KC_TAB),  G(KC_N),  G(KC_R),  G(KC_T),  G(KC_S),  G(S(KC_T)),   G(KC_Y),  G(KC_SPC),  G(KC_A),   G(KC_E),    G(S(KC_SPC)),   G(KC_COMM),              KC_TRNS,            KC_TRNS,
        KC_TRNS,    G(KC_BSPC),  G(KC_Q),  G(KC_X),  G(KC_M),  G(KC_C),   G(KC_V),  KC_TRNS,  G(S(KC_4)),  G(KC_P),  G(KC_LEFT),  G(KC_RIGHT),  G(S(KC_J)),  KC_TRNS,  KC_TRNS,
        KC_TRNS,    KC_TRNS,  KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,             G(KC_ENT),            G(KC_BSPC),            KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS),

    [SHORTS] = LAYOUT_90_ansi(
        KC_TRNS,    KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,            KC_TRNS,
        KC_TRNS,    KC_TRNS,        KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,     KC_TRNS,      KC_TRNS,      KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,    KC_TRNS,   KC_TRNS,            KC_TRNS,
        KC_TRNS,    A(KC_TAB),  A(S(KC_7)),  A(S(KC_U)),    A(S(KC_0)),  A(S(KC_8)),  A(S(KC_9)),   MEH(KC_E),  MEH(KC_A),  MEH(KC_O),  MEH(KC_S),  A(KC_J),  A(S(KC_EQL)),  KC_TRNS,  KC_TRNS,            KC_TRNS,
        KC_TRNS,    AE_SERVICE,  A(KC_7),  A(KC_U),  A(KC_0),  A(KC_8),  A(KC_9),   MEH(KC_G),  MEH(KC_C),  MEH(KC_P),   MEH(KC_W),    A(KC_K),   A(S(KC_MINS)),              KC_TRNS,            KC_TRNS,
        KC_TRNS,    KC_TRNS,            KC_LSFT,  C(S(KC_C)),  KC_LALT,  A(KC_COMM),   A(KC_SLSH),  KC_TRNS,  MEH(KC_F),  MEH(KC_M),  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
    ...
    [TERM] = LAYOUT_90_ansi(
        ...
        KC_TRNS,    KC_TRNS,            C(KC_Q),  KC_TRNS,  T_D,  C(KC_C),   C(KC_V),  KC_TRNS,  C(KC_K),  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
        KC_TRNS,    KC_TRNS,  KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,             KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS),
    ...
    [NAV] = LAYOUT_90_ansi(
        ...
        KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_LSFT,  KC_LGUI,  KC_TRNS,  KC_TRNS,   A(KC_LEFT),  KC_LEFT,  KC_DOWN,   KC_RIGHT,   A(KC_RIGHT),   KC_TRNS,              KC_TRNS,            KC_TRNS,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [NAV]   = { ENCODER_CCW_CW(BL_DOWN, BL_UP) },
};
